...
console.log("hihihihih" + process.env.DB_DIALECT);
const dbConfig = {
...
occasion_model_1.Occasion.hasMany(occurrence_model_1.Occurrence, {
  foreignKey: "occasionId",
});
occurrence_model_1.Occurrence.belongsTo(occasion_model_1.Occasion, {
  foreignKey: "occasionId",
});
customer_model_1.Customer.hasMany(registration_model_1.Registration, {
  foreignKey: "customerId",
});
registration_model_1.Registration.belongsTo(customer_model_1.Customer, {
  foreignKey: "customerId",
});
token_model_1.Token.belongsTo(customer_model_1.Customer, {
  foreignKey: "customerId",
  foreignKeyConstraint: false,
});
customer_model_1.Customer.hasOne(token_model_1.Token, {
  foreignKey: "customerId",
});
occurrence_model_1.Occurrence.hasMany(registration_model_1.Registration, {
  foreignKey: "occurrenceId",
});
registration_model_1.Registration.belongsTo(occurrence_model_1.Occurrence, {
  foreignKey: "occurrenceId",
});
const db = {
  sequelize: sequelize,
